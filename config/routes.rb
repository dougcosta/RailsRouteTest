ActionController::Routing::Routes.draw do |map|  
  ...
  map.car_create  "cars/:id", :controller => "cars", :action => "update",   :conditions => {:method => :put}
  map.car_create  "cars/:id", :controller => "cars", :action => "destroy",  :conditions => {:method => :delete}
end
